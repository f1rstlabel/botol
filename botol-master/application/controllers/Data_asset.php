...
public function update($id)
{
   ...
   public function index_kategori() {
    ...
    // Tambahan untuk menghindari error "Undefined variable: barang"
    $data['barang'] = $this->Asset_model->getAllBarang();

    // Memuat konten ke dalam template dashboard
    ...
    public function tambah_by_kategori() {
        ...
        $data['kategori'] = $this->Asset_model->get_categories_with_count();  // Pastikan ada method get_kategori() di model Anda
    ...
    public function form_peminjaman()
    {
        ...
        $data['dataasset'] = $this->Asset_model->getAllAssetOK();
        $data['contents'] = $this->load->view('data_asset/form_peminjaman', $data, true);
