    ...
    <div class="card-header bg-white py-3">
        <div class="row">
            ...
            <div class="col-auto">
                ...
                <!-- Tombol Peminjaman Multiple
                <a href="<?= base_url('dataasset/form_peminjaman') ?>" class="btn btn-sm btn-warning btn-icon-split ml-2">
                    <span class="icon"><i class="fas fa-hand-holding"></i></span>
                    <span class="text">Peminjaman Multiple</span>
                </a> -->
            </div>
...
$(document).ready(function() {
    ...
    success: function(response) {
        if (response.merk_kode !== undefined) {
            var merk_kode = response.merk_kode;
            var isShortOrSpecial = merk_kode.length < 3 || /[^a-zA-Z0-9]/.test(merk_kode);
            ...
            if (isShortOrSpecial) {
                ...
                barcodeText = randomLetters + Math.floor(Math.random() * 10000000000);
            } else {
                // Gunakan merk_kode + angka
                barcodeText = merk_kode + '_' + Math.floor(Math.random() * 10000000000);
            }
