            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="kategori" id="kategori" class="form-control" required>
                        ...
                        <option value="Switch Unmanaged" <?= set_select('kategori', 'Switch Unmanaged', $asset['kategori'] == 'Switch Unmanaged'); ?>>Switch Unmanaged</option>
                        <option value="Router" <?= set_select('kategori', 'Router', $asset['kategori'] == 'Router'); ?>>Router</option>
                        ...
                        <option value="Access Point" <?= set_select('kategori', 'Access Point', $asset['kategori'] == 'Access Point'); ?>>Access Point</option>
