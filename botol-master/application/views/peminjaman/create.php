...
<div class="form-group">
    ...
    <?php 
        $selected_barang_id = isset($_GET['id']) ? $_GET['id'] : set_value('barang_id');
    ?>
    <select name="barang_id" id="barang_id" class="form-control" required>
        ...
        <?php foreach ($barang as $item): ?> 
            ...
            data-merkkode="<?= $item['merk_kode']; ?>"

                <?= $selected_barang_id == $item['id'] ? 'selected' : '' ?>>
                <?= $item['nama_asset']; ?> (<?= $item['merk_kode']; ?>)
            </option>
        <?php endforeach; ?>
    </select>
...
<!-- <div class="form-group">
    ...
    <input type="text" name="merk_kode" id="merk_kode" class="form-control" readonly>
</div> -->
...
<div class="form-group">
 ...
 $(document).ready(function() {
    ...
    barangSelect.on('change', function() {
        ...
        const merkKode = selected.data('merkkode');

        stokInput.val(stok);
        barcodeInput.val(barcode);
        merkKodeInput.val(merkKode);
        jumlahPinjamInput.attr('max', stok);
    });

    // Cegah pinjam lebih dari stok
