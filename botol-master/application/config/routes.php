...
// Data asset routes
$route['data_asset'] = 'Data_asset/data';
$route['dataasset/add'] = 'Data_asset/add';
$route['dataasset/edit/(:num)'] = 'Data_asset/edit/$1'; 
$route['dataasset/update/(:num)'] = 'Data_asset/update/$1';
$route['dataasset/delete/(:num)'] = 'Data_asset/delete/$1';
...
$route['pengajuan_barang/update_request/(:num)'] = 'PengajuanBarang/update_request/$1';
...
$route['dataasset/save_barcode'] ['POST'] = 'data_asset/save_barcode';
