...
<head>
    ...
    <!-- <link href="<?= base_url('assets/vendor/select2/select2/dist/css/select2.min.css') ?>" rel="stylesheet"> -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item <?= ($segment == 'barangkeluar') ? "active":"" ?>">
...
<footer>
    ...
    <script type="text/javascript">
        ...
        let modal_total_bayar = $('#modal_total_bayar');
        ...
        $(document).on('keyup', '#diskon', function() {
            ...
            let total_bayar_formatted = (Number(totalNominal)).toLocaleString('id-ID', {
                style: 'currency',
                currency: 'IDR',
                minimumFractionDigits: 0
            });

            total_bayars.innerHTML = "Total Belanjaan adalah: " + total_bayar_formatted;
        });

        // $(document).on('keyup', '#diskon', function() {
        //     let totalNominal = parseInt(total_nominal_cart.val()) - parseFloat(this.value);
        //     grand_total.val(Number(totalNominal));
        //     modal_total_bayar.val(Number(totalNominal));
        // });
    </script>
